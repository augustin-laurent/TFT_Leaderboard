...
import { getPlayerPUUID, getPlayerID, getPlayerInformation, getMatches, getInformationLastMatches } from "@/lib/callRiot";
...
async function getPlayerData(username: string) {
    ...
    try {
        ...
        console.error("Failed to fetch player data, error might be related to Riot API check if the service is online", error);
    }
}